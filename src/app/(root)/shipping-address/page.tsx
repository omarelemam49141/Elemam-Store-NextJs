...
export const metadata: Metadata = {
  ...
  description: "Provide or update your shipping address to ensure fast, reliable delivery for your next order.",
  alternates: {
    canonical: "/shipping-address",
  },
  openGraph: {
    title: `${APP_NAME} | Shipping Address`,
    description: "Confirm your shipping details before moving to payment and review steps.",
